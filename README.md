...
- สลิปชำระเงินผ่าน LINE จะเก็บใน Supabase Storage bucket `SUPABASE_SLIP_BUCKET` หรือ `payment-slips` เมื่อไม่ระบุค่า
- การอนุมัติสลิปอัตโนมัติจะเกิดเฉพาะเมื่อ QR อ่านได้ ยอดตรง ไม่ซ้ำ พบเลขธุรกรรมใหม่ และข้อมูลบัญชีปลายทางตรงกับ `SLIP_RECEIVER_ACCOUNT_NAME`/`SLIP_RECEIVER_ACCOUNT_NUMBER`
