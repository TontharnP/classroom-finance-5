                  ...
                  <div className="flex gap-1">
                    {[
                      ...
                      <button
                        ...
                        className={`rounded-md px-2 py-1 text-xs transition-colors ${statusFilter === tab.key
                    ...
                    filteredStudents.map((student, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`flex items-center justify-between rounded-lg border p-3 dark:border-zinc-800 ${!hasPaid ? "cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-950/20 transition-colors" : ""
                            }`}
                        >
